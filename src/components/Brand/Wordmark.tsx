    ...
    <div className="flex items-center gap-2.5">
      <span className={cn('grid shrink-0 place-items-center rounded-[10px] shadow-card-sm', dim, tone === 'dark' ? 'bg-steel' : 'bg-white ring-1 ring-hairline')}>
        <svg viewBox="0 0 32 32" className="h-[66%] w-[66%]" fill="none" aria-hidden>
          <circle cx="16" cy="16" r="12.5" stroke="#1668C4" strokeWidth="1.3" opacity="0.35" />
          {/* bearing ticks */}
          <g stroke="#4E97E6" strokeWidth="1.2" opacity="0.7">
          ...
          {/* four-point lodestar */}
          <path d="M16 6 L18 14 L26 16 L18 18 L16 26 L14 18 L6 16 L14 14 Z" fill="#1668C4" />
          <circle cx="16" cy="16" r="2.1" fill="#0B2545" />
        </svg>
      </span>
