...
export const notifications: AppNotification[] = [
  ...
  },
  {
    ...
    body: 'Highly-sensitive HelpDesk report redacted; safe analytics version linked to case SF-44719.',
    time: '1 hr ago',
    unread: true,
  },
  {
  ...
  },
  {
    ...
    body: 'Anonymized regional risk trends shared with 230 member organizations — zero sensitive leakage.',
    time: 'Yesterday',
    unread: false,
  },
]
